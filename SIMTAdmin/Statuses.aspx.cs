...
public partial class SIMTAdmin_Statuses : AuthenticationPage
{
    ...
    {
        GXGridView1.TotalRecords = ActiveStatuse.SelectSearchCountCached(SearchControl1.SearchArguments);
        mvMain.SetActiveView(viewGrid);
    }
    ...
    {
        GXGridView1.TotalRecords = ActiveStatuse.SelectFilterCountCached(FilterControl1.FCFilterArgument);
    }
    ...
    {
        Statuse s = e.InputParameters["newEntity"] as Statuse;
        StatusController.ValidateUpdateCode(s.ID, s.Code);
    }
    ...
    {
        Statuse s = e.InputParameters["entityToInsert"] as Statuse;
        StatusController.ValidateInsertCode(s.Code);
    }
