<%@ Page Title="Статуси" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Statuses.aspx.cs" Inherits="SIMTAdmin_Statuses" %>
    ...
    <asp:MultiView ID="mvMain" runat="server">
            ...
            <div id="tabeliFrame">
                ...
                <div id="contentOuter">
                    <div id="contentInner">
                        ...
                        <cc1:GridViewDataSource ID="odsGridView" runat="server" TypeName="Broker.DataAccess.ActiveStatuse"
                                ...
                                <div style="float: right;">
                                    <cc1:FilterControl ID="FilterControl1" runat="server" GridViewToFilter="GXGridView1"
                                        ...
                                        <cc1:FilterItem FieldName="Тип на документ" PropertyName="DocumentTypeName" Comparator="StringComparators"
                                            DataType="String" />
                                        <cc1:FilterItem FieldName="Подтип на документ" PropertyName="DocumentSubTypeDescription"
                                            Comparator="StringComparators" DataType="String" />
                                    </cc1:FilterControl>
                                </div>
                                <cc1:FilterDataSource ID="odsFilterGridView" runat="server" TypeName="Broker.DataAccess.ActiveStatuse">
                                    <SelectParameters>
        ...
        <asp:View ID="viewEdit" runat="server">
            <div class="paddingKontroli">
                <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="dvDataSource" DataKeyNames="ID"
                    ...
                    <Fields>
                        <asp:TemplateField>
                            <InsertItemTemplate>
                                <div class="subTitles">
                                    Нов запис во Статуси
                                </div>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                                <div class="subTitles">
                                    Измена на запис во Статуси
                                </div>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <div class="subTitles">
                                    Бришење на запис од Статуси
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Шифра">
                            <InsertItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeInsertValidator" PropertyName="STATUS_CODE_INSERT_EXISTS"
                                    runat="server" />
                            </InsertItemTemplate>
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeUpdateValidator" PropertyName="STATUS_CODE_UPDATE_EXISTS"
                                    runat="server" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                ...
                <cc1:DetailsViewDataSource ID="dvDataSource" runat="server" TypeName="Broker.DataAccess.Statuse"
                    ConflictDetection="CompareAllValues" DataObjectTypeName="Broker.DataAccess.Statuse"
            ...
            <div class="paddingKontroli">
                <cc1:SearchControl ID="SearchControl1" runat="server" SearchDataSourceID="odsSearch"
                    ...
                    <cc1:SearchItem FieldName="Тип на документ" PropertyName="DocumentTypeName" Comparator="StringComparators"
                        DataType="String" />
                    <cc1:SearchItem FieldName="Подтип на документ" PropertyName="DocumentSubTypeDescription"
                        Comparator="StringComparators" DataType="String" />
                </cc1:SearchControl>
                <cc1:GridViewDataSource ID="odsSearch" runat="server" TypeName="Broker.DataAccess.ActiveStatuse"
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ActiveStatuse"
                    ...
                    <cc1:PrintItem HeaderText="Тип на документ" PropertyName="DocumentTypaName" />
                    <cc1:PrintItem HeaderText="Подтип на документ" PropertyName="DocumentSubTypeDescription" />
                </cc1:ReportControl>
            </div>
        </asp:View>
    </asp:MultiView>
