...
public partial class SIMTAdmin_PaymentTypes : AuthenticationPage
{
    protected void Page_Load(object sender, EventArgs e) {
        if (!IsPostBack) {
            GXGridView1.TotalRecords = Broker.DataAccess.PaymentType.SelectCountCached();
    ...
    protected void btnNew_Click(object sender, EventArgs e) {
        ...
        tbCode.Text = CodeGenerator.PaymentTypeCodeGenerator();
    ...
    protected void SearchControl1_Search(object sender, EventArgs e) {
        GXGridView1.TotalRecords = Broker.DataAccess.PaymentType.SelectSearchCountCached(SearchControl1.SearchArguments);
        mvMain.SetActiveView(viewGrid);
    }
    ...
    protected void FilterControl1_Filter(object sender, EventArgs e) {
        GXGridView1.TotalRecords = Broker.DataAccess.PaymentType.SelectFilterCountCached(FilterControl1.FCFilterArgument);
    }
