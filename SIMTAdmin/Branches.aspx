<%@ Page Title="Филијали" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Branches.aspx.cs" Inherits="SIMTAdmin_Branches" %>
    ...
    <asp:MultiView ID="mvMain" runat="server">
                ...
                <div id="contentOuter">
                    <div id="contentInner">
                        <cc1:GXGridView ID="GXGridView1" runat="server" DataSourceID="odsGridView" DataKeyNames="ID"
                            ...
                            Caption="Филијали" EmptyDataText="Нема записи кои го задоволуваат критериумот на пребарување!"
                        ...
                        <cc1:GridViewDataSource ID="odsGridView" runat="server" TypeName="Broker.DataAccess.ActiveBranch"
                        ...
                        <div class="pager">
                            <div class="container">
                                ...
                                <cc1:FilterDataSource ID="odsFilterGridView" runat="server" TypeName="Broker.DataAccess.ActiveBranch">
                                    <SelectParameters>
        ...
        <asp:View ID="viewEdit" runat="server">
            <div class="paddingKontroli">
                <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="dvDataSource" DataKeyNames="ID"
                    ...
                    <Fields>
                        <asp:TemplateField>
                            <InsertItemTemplate>
                                <div class="subTitles">
                                    Нов запис во Филијали
                                </div>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                                <div class="subTitles">
                                    Измена на запис во Филијали
                                </div>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <div class="subTitles">
                                    Бришење на запис од Филијали
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Шифра">
                            <InsertItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeInsertValidator" PropertyName="BRANCH_CODE_INSERT_EXISTS"
                                    runat="server" />
                            </InsertItemTemplate>
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeUpdateValidator" PropertyName="BRANCH_CODE_UPDATE_EXISTS"
                                    runat="server" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="">
                            <InsertItemTemplate>
                                <asp:DropDownList ID="ddlMunicipalities" runat="server" DataSourceID="odsMunicipalities"
                                    DataTextField="Name" DataValueField="ID" SelectedValue='<%# Bind("MunicipalityID") %>'>
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsMunicipalities" runat="server" SelectMethod="Select"
                            ...
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlMunicipalities" runat="server" DataSourceID="odsMunicipalities"
                                    Enabled="false" DataTextField="Name" DataValueField="ID" SelectedValue='<%# Bind("MunicipalityID") %>'>
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsMunicipalities" runat="server" SelectMethod="Select"
                                    TypeName="Broker.DataAccess.Municipality"></asp:ObjectDataSource>
                            </ItemTemplate>
                ...
                <cc1:DetailsViewDataSource ID="dvDataSource" runat="server" TypeName="Broker.DataAccess.Branch"
                    ConflictDetection="CompareAllValues" DataObjectTypeName="Broker.DataAccess.Branch"
        ...
        <asp:View ID="viewSearch" runat="server">
            <div class="paddingKontroli">
                ...
                <cc1:GridViewDataSource ID="odsSearch" runat="server" TypeName="Broker.DataAccess.ActiveBranch"
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ActiveBranch"
