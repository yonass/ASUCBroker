<%@ Page Title="Документи за задолжување на полиси (од филијала)" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="DistributionDocumentsPerBranch.aspx.cs" Inherits="SEAdmin_DistributionDocumentsPerBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="kontroli">
        ...
        <div id="button06">
            <asp:Button ID="btnChangeStatus" runat="server" ToolTip="Промена на статус на документ"
                OnClick="btnChangeStatus_Click" CssClass="izmeni" BorderWidth="0px" />
        </div>
    </div>
    <asp:MultiView ID="mvMain" runat="server">
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ViewDistributionDocument"
                    ...
                    OnDataBinding="reportControl_DataBinding" OnPrint="reportControl_Print">
        ...
        <asp:View ID="viewChangeStatus" runat="server">
            <div class="paddingKontroli">
                <asp:DetailsView ID="dvChangeStatusDistributionDocumentInfo" runat="server" DataSourceID="odsDistributionDocument"
                    AutoGenerateRows="false" GridLines="None" DefaultMode="ReadOnly">
                    <Fields>
                        <asp:TemplateField HeaderText="Број на документ">
                            <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rblAnswer" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Text="Се прифаќа" Value="Accept"></asp:ListItem>
                                <asp:ListItem Text="Се одбива" Value="Deny"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnAnswer" runat="server" Text="Сними" OnClick="btnAnswer_Click" />
                        </td>
                    </tr>
                </table>
            </div>
