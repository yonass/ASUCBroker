<%@ Page Title="Преглед на задолжени полиси (во филијала)" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="DistributionsPerBranch.aspx.cs" Inherits="SEAdmin_DistributionsPerBranch" %>
            ...
            <div class="paddingKontroli">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="tbPovratnica" runat="server" Text="Повратница" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ObjectDataSource ID="InsuranceTypeDataSource" runat="server" SelectMethod="GetForDistributionByCompany"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ObjectDataSource ID="InsuranceSubTypeDataSource" runat="server" SelectMethod="GetForDistributionByInsuranceTypeAndCompany"
