...
public partial class SEAdmin_DistributionRoutes : AuthenticationPage {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        if (!IsPostBack) {
            GXGridView1.TotalRecords = ViewDistributionRoute.SelectCountCached();
    ...
    protected void SearchControl1_Search(object sender, EventArgs e) {
        GXGridView1.TotalRecords = ViewDistributionRoute.SelectSearchCountCached(SearchControl1.SearchArguments);
        mvMain.SetActiveView(viewGrid);
    }
    ...
    protected void FilterControl1_Filter(object sender, EventArgs e) {
        GXGridView1.TotalRecords = ViewDistributionRoute.SelectFilterCountCached(FilterControl1.FCFilterArgument);
    }
