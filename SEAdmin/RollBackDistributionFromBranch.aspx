<%@ Page Title="Раздолжувања од филијали" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="RollBackDistributionFromBranch.aspx.cs" Inherits="SEAdmin_RollBackDistributionFromBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="kontroli">
        ...
        <div id="button05">
            <asp:Button ID="btnConfirm" runat="server" ToolTip="Потврди" CssClass="potvrdi" BorderWidth="0px"
    ...
    <asp:MultiView ID="mvMain" runat="server">
            ...
            <div id="tabeliFrame">
                ...
                <div id="contentOuter">
                    <div id="contentInner">
                        ...
                        <cc1:GridViewDataSource ID="odsGridView" runat="server" TypeName="Broker.DataAccess.ViewRollBackDistributionBranch"
                        ...
                        <div class="pager">
                            <div class="container">
                                ...
                                <cc1:FilterDataSource ID="odsFilterGridView" runat="server" TypeName="Broker.DataAccess.ViewRollBackDistributionBranch">
                                    <SelectParameters>
        ...
        <asp:View ID="viewSearch" runat="server">
            <div class="paddingKontroli">
                ...
                <cc1:GridViewDataSource ID="odsSearch" runat="server" TypeName="Broker.DataAccess.ViewRollBackDistributionBranch"
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ViewRollBackDistributionBranch"
