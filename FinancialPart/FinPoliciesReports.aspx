<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="FinPoliciesReports.aspx.cs" Inherits="FinancialPart_FinPoliciesReports" %>
        ...
        <div id="contentOuter">
            <div id="contentInner">
                ...
                <table>
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="rblSeparatePeriodType" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Text="дневно" Value="day"></asp:ListItem>
                                <asp:ListItem Text="месечно" Value="month"></asp:ListItem>
                                <asp:ListItem Text="квартално" Value="quarterly"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="rblGroupType" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Text="ЗБИРНО" Value="total"></asp:ListItem>
                                <asp:ListItem Text="ПОЕДИНЕЧНО" Value="one"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Panel ID="checkBoxPanelInsuranceSubTypes" runat="server" CssClass="scrollingControlContainer scrollingCheckBoxList">
                                <asp:CheckBox ID="cbAllInsuranceSubTypes" runat="server" AutoPostBack="true" Text="Сите"
                                    OnCheckedChanged="cbAllInsuranceSubTypes_CheckedChanged" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Panel ID="checkBoxPanelReportItems" runat="server" CssClass="scrollingControlContainer scrollingCheckBoxList">
                                <asp:CheckBoxList ID="cblReportItems" runat="server">
                                    <asp:ListItem Text="ПОЛИСИРАНА ПРЕМИЈА" Value="RealPolicyValue"></asp:ListItem>
                                    <asp:ListItem Text="ПРЕМИЈА ЗА НАПЛАТА" Value="PremiumValue"></asp:ListItem>
                                    <asp:ListItem Text="НАПЛАТЕНА ПРЕМИЈА" Value="PaidPremiumValue"></asp:ListItem>
                                    <asp:ListItem Text="НАПЛАТЕНА ПРЕМИЈА (%)" Value="PaidPremiumValuePercent"></asp:ListItem>
                                    <asp:ListItem Text="ДОЛЖНА ПРЕМИЈА" Value="DebtPremiumValue"></asp:ListItem>
                                    <asp:ListItem Text="ДОСП.ДОЛЖНА ПРЕМИЈА" Value="DebtExpectedPremiumValue"></asp:ListItem>
                                    <asp:ListItem Text="ФАКТУРИРАНА БРОКЕРАЖА" Value="FacturedBrokerageValue"></asp:ListItem>
                                    <asp:ListItem Text="ПРОВИЗИЈА ЗА АГЕНТИ" Value="MarkAgentProvisionValue"></asp:ListItem>
                                </asp:CheckBoxList>
                            </asp:Panel>
                        </td>
                    </tr>
