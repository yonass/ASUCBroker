<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LoggingReportPagesAndActions.aspx.cs" Inherits="Broker_LoggingReportPagesAndActions" Title="Преглед на посетени страни и акции" %>
            ...
            <ContentTemplate>
                <asp:GridView ID="gvDBActivitiesBase" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                            ...
                            <ItemTemplate>
                                ...
                                <div id="div<%# Eval("ID") %>" style="display: none;">
                                    <asp:GridView ID="gvDBActivities" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ForeColor="#333333" GridLines="None" OnRowDataBound = "gvDBActivities_RowDataBound" DataKeyNames = "ID"
                                        ShowFooter="True" Width="100%" AllowPaging="false"  BorderStyle = "Groove" BorderWidth = "2">
                                        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" BorderStyle = "Groove" BorderWidth = "2" />
                                        <Columns>
                                            <asp:BoundField DataField="Action" ShowHeader = "true" InsertVisible="False" ReadOnly="True"
                                                SortExpression="Action" HeaderText = "Акција" >
                                            ...
                                            <%--<asp:BoundField DataField="TimeAccessesed" ShowHeader = "true" InsertVisible="False" ReadOnly="True"
                                                SortExpression="TimeAccessesed" HeaderText = "Време" >
                                                <HeaderStyle HorizontalAlign="Left" Height = "50px" />
                                            </asp:BoundField>--%>
                                            <asp:TemplateField ShowHeader="true" HeaderText = "" >
                                                <ItemTemplate>
                                                    ...
                                                    <div id="div<%# Eval("ID") %>" style = "display:block" >
                        ...
                        <asp:BoundField DataField="Title" ShowHeader = "true" InsertVisible="False" ReadOnly="True"
                            SortExpression="Title" HeaderText = "Име на страната" >
                            <HeaderStyle HorizontalAlign="Left" Height = "50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TimeOfAccess" ShowHeader = "true" InsertVisible="False" ReadOnly="True"
                            SortExpression="TimeOfAccess" HeaderText = "Време" >
                            <HeaderStyle HorizontalAlign="Left" Height = "50px" />
                        </asp:BoundField>
                    </Columns>
                    <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
