...
public partial class BROKERAdmin_Deals : AuthenticationPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            GXGridView1.TotalRecords = ActiveDeal.SelectCountCached();
    ...
    {
        GXGridView1.TotalRecords = ActiveDeal.SelectSearchCountCached(SearchControl1.SearchArguments);
        mvMain.SetActiveView(viewGrid);
    }
    ...
    {
        GXGridView1.TotalRecords = ActiveDeal.SelectFilterCountCached(FilterControl1.FCFilterArgument);
    }
    ...
    protected void btnDelete_Click1(object sender, EventArgs e)
    {
        if (GXGridView1.SelectedIndex != -1)
        {
            ...
            d.IsActive = false;
            Deal.Table.Context.SubmitChanges();
