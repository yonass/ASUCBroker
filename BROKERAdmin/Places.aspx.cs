...
public partial class BROKERAdmin_Places : AuthenticationPage
{
    ...
    {
        GXGridView1.TotalRecords = ActivePlace.SelectSearchCountCached(SearchControl1.SearchArguments);
        mvMain.SetActiveView(viewGrid);
    }
    ...
    {
        GXGridView1.TotalRecords = ActivePlace.SelectFilterCountCached(FilterControl1.FCFilterArgument);
    }
