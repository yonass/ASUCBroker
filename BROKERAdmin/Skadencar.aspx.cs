...
public partial class BROKERAdmin_Skadencar : AuthenticationPage {
    ...
    protected void btnReport_Click(object sender, EventArgs e) {
        ...
        PrintsSkadencar.PrintSkadencar(fromDate, toDate, lstBranches, lstInsuranceCompanies, lstInsuranceSubTypes);
