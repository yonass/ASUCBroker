...
public partial class BROKERAdmin_InsuranceCompanies : AuthenticationPage
{
    ...
    {
        GXGridView1.TotalRecords = ActiveInsuranceCompany.SelectSearchCountCached(SearchControl1.SearchArguments);
        mvMain.SetActiveView(viewGrid);
    }
    ...
    {
        GXGridView1.TotalRecords = ActiveInsuranceCompany.SelectFilterCountCached(FilterControl1.FCFilterArgument);
    }
    ...
    {
        InsuranceCompany ic = e.InputParameters["newEntity"] as InsuranceCompany;
        InsuranceCompanyController.ValidateUpdateCode(ic.ID, ic.Code);
    }
    ...
    {
        InsuranceCompany ic = e.InputParameters["entityToInsert"] as InsuranceCompany;
        InsuranceCompanyController.ValidateInsertCode(ic.Code);
    }
