<%@ Page Title="Населени места" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Places.aspx.cs" Inherits="BROKERAdmin_Places" %>
    ...
    <asp:MultiView ID="mvMain" runat="server">
                ...
                <div id="contentOuter">
                    <div id="contentInner">
                        <cc1:GXGridView ID="GXGridView1" runat="server" DataSourceID="odsGridView" DataKeyNames="ID"
                            ...
                            Caption="Населени места" EmptyDataText="Нема записи кои го задоволуваат критериумот на пребарување!"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Општина" DataField="MunicipalityName" SortExpression="MunicipalityName" />
                            </Columns>
                        ...
                        <cc1:GridViewDataSource ID="odsGridView" runat="server" TypeName="Broker.DataAccess.ActivePlace"
                        ...
                        <div class="pager">
                            <div class="container">
                                ...
                                <cc1:FilterDataSource ID="odsFilterGridView" runat="server" TypeName="Broker.DataAccess.ActivePlace">
                                    <SelectParameters>
        ...
        <asp:View ID="viewEdit" runat="server">
            <div class="paddingKontroli">
                <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="dvDataSource" DataKeyNames="ID"
                    ...
                    <Fields>
                        <asp:TemplateField>
                            <InsertItemTemplate>
                                <div class="subTitles">
                                    Нов запис во Населени места
                                </div>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                                <div class="subTitles">
                                    Измена на запис во Населени места
                                </div>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <div class="subTitles">
                                    Бришење на запис од Населени места
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Шифра">
                            <InsertItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeInsertValidator" PropertyName="PLACE_CODE_INSERT_EXISTS"
                                    runat="server" />
                            </InsertItemTemplate>
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeUpdateValidator" PropertyName="PLACE_CODE_UPDATE_EXISTS"
                                    runat="server" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Општина">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlMunicipalities" runat="server" Enabled="False" 
                                    DataSourceID="odsMunicipalities" DataTextField="Name" DataValueField="ID" 
                                    SelectedValue='<%# Bind("MunicipalityID") %>'>
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsMunicipalities" runat="server" 
                                    SelectMethod="Select" TypeName="Broker.DataAccess.Municipality">
                                </asp:ObjectDataSource>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlMunicipalities" runat="server" 
                                    DataSourceID="odsActiveMunicipalities" DataTextField="Name" DataValueField="ID" 
                                    SelectedValue='<%# Bind("MunicipalityID") %>'>
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsActiveMunicipalities" runat="server" 
                                    SelectMethod="GetActiveMunicipalities" 
                                    TypeName="Broker.DataAccess.Municipality"></asp:ObjectDataSource>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:DropDownList ID="ddlMunicipalities" runat="server" 
                                    DataSourceID="odsActiveMunicipalities" DataTextField="Name" DataValueField="ID" 
                ...
                <cc1:DetailsViewDataSource ID="dvDataSource" runat="server" TypeName="Broker.DataAccess.Place"
                    ConflictDetection="CompareAllValues" DataObjectTypeName="Broker.DataAccess.Place"
        ...
        <asp:View ID="viewSearch" runat="server">
            <div class="paddingKontroli">
                ...
                <cc1:GridViewDataSource ID="odsSearch" runat="server" TypeName="Broker.DataAccess.ActivePlace"
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ActivePlace"
