<%@ Page Title="Држави" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="States.aspx.cs" Inherits="BROKERAdmin_States" %>
    ...
    <asp:MultiView ID="mvMain" runat="server">
                ...
                <div id="contentOuter">
                    <div id="contentInner">
                        <cc1:GXGridView ID="GXGridView1" runat="server" DataSourceID="odsGridView" DataKeyNames="ID"
                            ...
                            Caption="Држави" EmptyDataText="Нема записи кои го задоволуваат критериумот на пребарување!"
                        ...
                        <cc1:GridViewDataSource ID="odsGridView" runat="server" TypeName="Broker.DataAccess.ActiveState"
                        ...
                        <div class="pager">
                            <div class="container">
                                ...
                                <cc1:FilterDataSource ID="odsFilterGridView" runat="server" TypeName="Broker.DataAccess.ActiveState">
                                    <SelectParameters>
        ...
        <asp:View ID="viewEdit" runat="server">
            <div class="paddingKontroli">
                <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="dvDataSource" DataKeyNames="ID"
                    ...
                    <Fields>
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <div class="subTitles">
                                    Измена на запис во Држави
                                </div>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <div class="subTitles">
                                    Бришење на запис од Држави
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Шифра">
                            <InsertItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeInsertValidator" PropertyName="STATE_CODE_INSERT_EXISTS"
                                    runat="server" />
                            </InsertItemTemplate>
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeUpdateValidator" PropertyName="STATE_CODE_UPDATE_EXISTS"
                                    runat="server" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                ...
                <cc1:DetailsViewDataSource ID="dvDataSource" runat="server" TypeName="Broker.DataAccess.State"
                    ConflictDetection="CompareAllValues" DataObjectTypeName="Broker.DataAccess.State"
        ...
        <asp:View ID="viewSearch" runat="server">
            <div class="paddingKontroli">
                ...
                <cc1:GridViewDataSource ID="odsSearch" runat="server" TypeName="Broker.DataAccess.ActiveState"
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ActiveState"
