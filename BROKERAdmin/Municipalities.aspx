<%@ Page Title="Општини" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Municipalities.aspx.cs" Inherits="BROKERAdmin_Municipalities" %>
    ...
    <asp:MultiView ID="mvMain" runat="server">
                ...
                <div id="contentOuter">
                    <div id="contentInner">
                        <cc1:GXGridView ID="GXGridView1" runat="server" DataSourceID="odsGridView" DataKeyNames="ID"
                            ...
                            Caption="Општини" EmptyDataText="Нема записи кои го задоволуваат критериумот на пребарување!"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Држава" DataField="StateName" SortExpression="StateName" />
                            </Columns>
                        ...
                        <cc1:GridViewDataSource ID="odsGridView" runat="server" TypeName="Broker.DataAccess.ActiveMunicipality"
                                ...
                                <div style="float: right;">
                                    <cc1:FilterControl ID="FilterControl1" runat="server" GridViewToFilter="GXGridView1"
                                        ...
                                        <cc1:FilterItem FieldName="Име" PropertyName="Name" Comparator="StringComparators"
                                            DataType="String" />
                                        <cc1:FilterItem FieldName="Држава" PropertyName="StateName" Comparator="StringComparators"
                                            DataType="String" />
                                    </cc1:FilterControl>
                                </div>
                                <cc1:FilterDataSource ID="odsFilterGridView" runat="server" TypeName="Broker.DataAccess.ActiveMunicipality">
                                    <SelectParameters>
        ...
        <asp:View ID="viewEdit" runat="server">
            <div class="paddingKontroli">
                <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="dvDataSource" DataKeyNames="ID"
                    ...
                    <Fields>
                        <asp:TemplateField>
                            <InsertItemTemplate>
                                <div class="subTitles">
                                    Нов запис во Општини
                                </div>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                                <div class="subTitles">
                                    Измена на запис во Општини
                                </div>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <div class="subTitles">
                                    Бришење на запис од Општини
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Шифра">
                            ...
                            <EditItemTemplate>
                                ...
                                <super:EntityCallOutValidator ID="CodeUpdateValidator" PropertyName="MUNICIPALITY_CODE_UPDATE_EXISTS"
                                    runat="server" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Држава">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlStates" runat="server" Enabled="False" DataSourceID="odsStates"
                                    DataTextField="Name" DataValueField="ID" SelectedValue='<%# Bind("StateID") %>'>
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsStates" runat="server" SelectMethod="Select" TypeName="Broker.DataAccess.State">
                                </asp:ObjectDataSource>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlStates" runat="server" DataSourceID="odsActiveStates" DataTextField="Name"
                                    DataValueField="ID" SelectedValue='<%# Bind("StateID") %>'>
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsActiveStates" runat="server" SelectMethod="GetActiveStates"
                                    TypeName="Broker.DataAccess.State"></asp:ObjectDataSource>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:DropDownList ID="ddlStates" runat="server" DataSourceID="odsActiveStates" DataTextField="Name"
                                    DataValueField="ID" SelectedValue='<%# Bind("StateID") %>'>
                ...
                <cc1:DetailsViewDataSource ID="dvDataSource" runat="server" TypeName="Broker.DataAccess.Municipality"
                    ConflictDetection="CompareAllValues" DataObjectTypeName="Broker.DataAccess.Municipality"
            ...
            <div class="paddingKontroli">
                <cc1:SearchControl ID="SearchControl1" runat="server" SearchDataSourceID="odsSearch"
                    ...
                    <cc1:SearchItem FieldName="Име" PropertyName="Name" Comparator="StringComparators"
                        DataType="String" />
                    <cc1:SearchItem FieldName="Држава" PropertyName="StateName" Comparator="StringComparators"
                        DataType="String" />
                </cc1:SearchControl>
                <cc1:GridViewDataSource ID="odsSearch" runat="server" TypeName="Broker.DataAccess.ActiveMunicipality"
        ...
        <asp:View ID="viewReport" runat="server">
            <div class="paddingKontroli">
                <cc1:ReportControl ID="reportControl" runat="server" TypeName="Broker.DataAccess.ActiveMunicipality"
                    ...
                    <cc1:PrintItem HeaderText="Држава" PropertyName="StateName" />
                </cc1:ReportControl>
            </div>
        </asp:View>
    </asp:MultiView>
